...
const (
	...
	API_ListClustersV2_FullMethodName           = "/com.spirl.api.v1.cluster.API/ListClustersV2"
	API_DescribeClusters_FullMethodName         = "/com.spirl.api.v1.cluster.API/DescribeClusters"
...
type APIClient interface {
	...
	// Lists clusters with optional filtering. Returns basic cluster attributes only.
	ListClustersV2(ctx context.Context, in *ListClustersV2Request, opts ...grpc.CallOption) (*ListClustersV2Response, error)
	// Describes clusters.
...
func (c *aPIClient) ListClustersV2(ctx context.Context, in *ListClustersV2Request, opts ...grpc.CallOption) (*ListClustersV2Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListClustersV2Response)
	err := c.cc.Invoke(ctx, API_ListClustersV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) DescribeClusters(ctx context.Context, in *DescribeClustersRequest, opts ...grpc.CallOption) (*DescribeClustersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DescribeClustersResponse)
	err := c.cc.Invoke(ctx, API_DescribeClusters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	// Lists clusters with optional filtering. Returns basic cluster attributes only.
	ListClustersV2(context.Context, *ListClustersV2Request) (*ListClustersV2Response, error)
	// Describes clusters.
...
func (UnimplementedAPIServer) ListClustersV2(context.Context, *ListClustersV2Request) (*ListClustersV2Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListClustersV2 not implemented")
}
func (UnimplementedAPIServer) DescribeClusters(context.Context, *DescribeClustersRequest) (*DescribeClustersResponse, error) {
...
func _API_ListClustersV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListClustersV2Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ListClustersV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ListClustersV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ListClustersV2(ctx, req.(*ListClustersV2Request))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_DescribeClusters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DescribeClustersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).DescribeClusters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_DescribeClusters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).DescribeClusters(ctx, req.(*DescribeClustersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListClustersV2",
			Handler:    _API_ListClustersV2_Handler,
		},
		{
			MethodName: "DescribeClusters",
			Handler:    _API_DescribeClusters_Handler,
		},
		{
