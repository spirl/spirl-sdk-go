...
const (
	...
	API_UpdateTrustDomain_FullMethodName                 = "/com.spirl.api.v1.trustdomain.API/UpdateTrustDomain"
	...
	API_TrustDomainSigningAuthorityStatus_FullMethodName = "/com.spirl.api.v1.trustdomain.API/TrustDomainSigningAuthorityStatus"
	API_PrepareDeploymentKeySet_FullMethodName           = "/com.spirl.api.v1.trustdomain.API/PrepareDeploymentKeySet"
	API_ActivateDeploymentKeySet_FullMethodName          = "/com.spirl.api.v1.trustdomain.API/ActivateDeploymentKeySet"
	API_TaintDeploymentKeySet_FullMethodName             = "/com.spirl.api.v1.trustdomain.API/TaintDeploymentKeySet"
	API_RemoveDeploymentKeySet_FullMethodName            = "/com.spirl.api.v1.trustdomain.API/RemoveDeploymentKeySet"
)
...
type APIClient interface {
	...
	// Endpoint to update a trust domain.
	UpdateTrustDomain(ctx context.Context, in *UpdateTrustDomainRequest, opts ...grpc.CallOption) (*UpdateTrustDomainResponse, error)
	...
	// Endpoint to get the signing authority status for a trust domain.
	// This operation contacts signer deployments and may be slow or unavailable
	// when no signers are reachable.
	TrustDomainSigningAuthorityStatus(ctx context.Context, in *TrustDomainSigningAuthorityStatusRequest, opts ...grpc.CallOption) (*TrustDomainSigningAuthorityStatusResponse, error)
	// Prepare a new key set for a deployment. The new key set enters the
	// prepared state and must be activated before it becomes the active signer.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	PrepareDeploymentKeySet(ctx context.Context, in *PrepareDeploymentKeySetRequest, opts ...grpc.CallOption) (*PrepareDeploymentKeySetResponse, error)
	// Activate a prepared key set for a deployment, making it the active signer.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	ActivateDeploymentKeySet(ctx context.Context, in *ActivateDeploymentKeySetRequest, opts ...grpc.CallOption) (*ActivateDeploymentKeySetResponse, error)
	// Taint a key set for a deployment. Tainted keys remain in the trust bundle
	// but are marked so that agents proactively rotate workload SVIDs signed by
	// this key set. Concurrent key rotation operations on the same deployment are
	// not allowed and will fail immediately — callers must handle this and retry
	// if needed.
	TaintDeploymentKeySet(ctx context.Context, in *TaintDeploymentKeySetRequest, opts ...grpc.CallOption) (*TaintDeploymentKeySetResponse, error)
	// Remove a tainted key set from a deployment, evicting it from the bundle.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	RemoveDeploymentKeySet(ctx context.Context, in *RemoveDeploymentKeySetRequest, opts ...grpc.CallOption) (*RemoveDeploymentKeySetResponse, error)
}
...
func (c *aPIClient) UpdateTrustDomain(ctx context.Context, in *UpdateTrustDomainRequest, opts ...grpc.CallOption) (*UpdateTrustDomainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateTrustDomainResponse)
	err := c.cc.Invoke(ctx, API_UpdateTrustDomain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) TrustDomainSigningAuthorityStatus(ctx context.Context, in *TrustDomainSigningAuthorityStatusRequest, opts ...grpc.CallOption) (*TrustDomainSigningAuthorityStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TrustDomainSigningAuthorityStatusResponse)
	err := c.cc.Invoke(ctx, API_TrustDomainSigningAuthorityStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) PrepareDeploymentKeySet(ctx context.Context, in *PrepareDeploymentKeySetRequest, opts ...grpc.CallOption) (*PrepareDeploymentKeySetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PrepareDeploymentKeySetResponse)
	err := c.cc.Invoke(ctx, API_PrepareDeploymentKeySet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ActivateDeploymentKeySet(ctx context.Context, in *ActivateDeploymentKeySetRequest, opts ...grpc.CallOption) (*ActivateDeploymentKeySetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActivateDeploymentKeySetResponse)
	err := c.cc.Invoke(ctx, API_ActivateDeploymentKeySet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) TaintDeploymentKeySet(ctx context.Context, in *TaintDeploymentKeySetRequest, opts ...grpc.CallOption) (*TaintDeploymentKeySetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TaintDeploymentKeySetResponse)
	err := c.cc.Invoke(ctx, API_TaintDeploymentKeySet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) RemoveDeploymentKeySet(ctx context.Context, in *RemoveDeploymentKeySetRequest, opts ...grpc.CallOption) (*RemoveDeploymentKeySetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveDeploymentKeySetResponse)
	err := c.cc.Invoke(ctx, API_RemoveDeploymentKeySet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	// Endpoint to update a trust domain.
	UpdateTrustDomain(context.Context, *UpdateTrustDomainRequest) (*UpdateTrustDomainResponse, error)
	// Endpoint to list a trust domain's deployments.
	...
	// This operation contacts signer deployments and may be slow or unavailable
	// when no signers are reachable.
	TrustDomainSigningAuthorityStatus(context.Context, *TrustDomainSigningAuthorityStatusRequest) (*TrustDomainSigningAuthorityStatusResponse, error)
	// Prepare a new key set for a deployment. The new key set enters the
	// prepared state and must be activated before it becomes the active signer.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	PrepareDeploymentKeySet(context.Context, *PrepareDeploymentKeySetRequest) (*PrepareDeploymentKeySetResponse, error)
	// Activate a prepared key set for a deployment, making it the active signer.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	ActivateDeploymentKeySet(context.Context, *ActivateDeploymentKeySetRequest) (*ActivateDeploymentKeySetResponse, error)
	// Taint a key set for a deployment. Tainted keys remain in the trust bundle
	// but are marked so that agents proactively rotate workload SVIDs signed by
	// this key set. Concurrent key rotation operations on the same deployment are
	// not allowed and will fail immediately — callers must handle this and retry
	// if needed.
	TaintDeploymentKeySet(context.Context, *TaintDeploymentKeySetRequest) (*TaintDeploymentKeySetResponse, error)
	// Remove a tainted key set from a deployment, evicting it from the bundle.
	// Concurrent key rotation operations on the same deployment are not allowed
	// and will fail immediately — callers must handle this and retry if needed.
	RemoveDeploymentKeySet(context.Context, *RemoveDeploymentKeySetRequest) (*RemoveDeploymentKeySetResponse, error)
...
func (UnimplementedAPIServer) UpdateTrustDomain(context.Context, *UpdateTrustDomainRequest) (*UpdateTrustDomainResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTrustDomain not implemented")
}
...
func (UnimplementedAPIServer) TrustDomainSigningAuthorityStatus(context.Context, *TrustDomainSigningAuthorityStatusRequest) (*TrustDomainSigningAuthorityStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrustDomainSigningAuthorityStatus not implemented")
}
func (UnimplementedAPIServer) PrepareDeploymentKeySet(context.Context, *PrepareDeploymentKeySetRequest) (*PrepareDeploymentKeySetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrepareDeploymentKeySet not implemented")
}
func (UnimplementedAPIServer) ActivateDeploymentKeySet(context.Context, *ActivateDeploymentKeySetRequest) (*ActivateDeploymentKeySetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivateDeploymentKeySet not implemented")
}
func (UnimplementedAPIServer) TaintDeploymentKeySet(context.Context, *TaintDeploymentKeySetRequest) (*TaintDeploymentKeySetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaintDeploymentKeySet not implemented")
}
func (UnimplementedAPIServer) RemoveDeploymentKeySet(context.Context, *RemoveDeploymentKeySetRequest) (*RemoveDeploymentKeySetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveDeploymentKeySet not implemented")
}
...
func _API_UpdateTrustDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTrustDomainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).UpdateTrustDomain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_UpdateTrustDomain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).UpdateTrustDomain(ctx, req.(*UpdateTrustDomainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _API_TrustDomainSigningAuthorityStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrustDomainSigningAuthorityStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).TrustDomainSigningAuthorityStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_TrustDomainSigningAuthorityStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).TrustDomainSigningAuthorityStatus(ctx, req.(*TrustDomainSigningAuthorityStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_PrepareDeploymentKeySet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PrepareDeploymentKeySetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).PrepareDeploymentKeySet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_PrepareDeploymentKeySet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).PrepareDeploymentKeySet(ctx, req.(*PrepareDeploymentKeySetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_ActivateDeploymentKeySet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivateDeploymentKeySetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ActivateDeploymentKeySet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ActivateDeploymentKeySet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ActivateDeploymentKeySet(ctx, req.(*ActivateDeploymentKeySetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_TaintDeploymentKeySet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaintDeploymentKeySetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).TaintDeploymentKeySet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_TaintDeploymentKeySet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).TaintDeploymentKeySet(ctx, req.(*TaintDeploymentKeySetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_RemoveDeploymentKeySet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveDeploymentKeySetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).RemoveDeploymentKeySet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_RemoveDeploymentKeySet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).RemoveDeploymentKeySet(ctx, req.(*RemoveDeploymentKeySetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTrustDomain",
			Handler:    _API_UpdateTrustDomain_Handler,
		},
		{
		...
		{
			MethodName: "TrustDomainSigningAuthorityStatus",
			Handler:    _API_TrustDomainSigningAuthorityStatus_Handler,
		},
		{
			MethodName: "PrepareDeploymentKeySet",
			Handler:    _API_PrepareDeploymentKeySet_Handler,
		},
		{
			MethodName: "ActivateDeploymentKeySet",
			Handler:    _API_ActivateDeploymentKeySet_Handler,
		},
		{
			MethodName: "TaintDeploymentKeySet",
			Handler:    _API_TaintDeploymentKeySet_Handler,
		},
		{
			MethodName: "RemoveDeploymentKeySet",
			Handler:    _API_RemoveDeploymentKeySet_Handler,
		},
	},
