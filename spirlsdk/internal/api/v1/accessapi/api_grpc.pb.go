...
const (
	...
	API_ListDelegatedAdmins_FullMethodName           = "/com.spirl.api.v1.access.API/ListDelegatedAdmins"
)
...
type APIClient interface {
	...
	// Lists delegated admins grouped by realm.
	ListDelegatedAdmins(ctx context.Context, in *ListDelegatedAdminsRequest, opts ...grpc.CallOption) (*ListDelegatedAdminsResponse, error)
}
...
func (c *aPIClient) ListDelegatedAdmins(ctx context.Context, in *ListDelegatedAdminsRequest, opts ...grpc.CallOption) (*ListDelegatedAdminsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDelegatedAdminsResponse)
	err := c.cc.Invoke(ctx, API_ListDelegatedAdmins_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	// Lists delegated admins grouped by realm.
	ListDelegatedAdmins(context.Context, *ListDelegatedAdminsRequest) (*ListDelegatedAdminsResponse, error)
...
func (UnimplementedAPIServer) ListDelegatedAdmins(context.Context, *ListDelegatedAdminsRequest) (*ListDelegatedAdminsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListDelegatedAdmins not implemented")
}
...
func _API_ListDelegatedAdmins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDelegatedAdminsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ListDelegatedAdmins(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ListDelegatedAdmins_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ListDelegatedAdmins(ctx, req.(*ListDelegatedAdminsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListDelegatedAdmins",
			Handler:    _API_ListDelegatedAdmins_Handler,
		},
	},
