...
const (
	...
	API_StartLogin_FullMethodName                 = "/com.spirl.api.v1.session.API/StartLogin"
	API_FinishLogin_FullMethodName                = "/com.spirl.api.v1.session.API/FinishLogin"
...
type APIClient interface {
	...
	// The unary StartLogin / FinishLogin pair targets the modern pairing-code
	// flow, where org selection happens (if needed) in the browser, unless it's
	// already provided by an --org flag.
	//
	// Login is pre-auth: the caller has no token and no org context, so the
	// audit augmenter must not try to read an org ID from auth context.
	// Without the org_origin annotation the unary server audit interceptor
	// rejects the RPC with codes.Unauthenticated before it reaches the
	// handler. The trust_domain_origin annotation defaults to "field
	// trust_domain_id" if unset; login requests carry no such field, so we
	// pin it to none here to keep the augmenter from logging a misleading
	// "Field not found" ERROR on every login.
...
func (c *aPIClient) StartLogin(ctx context.Context, in *StartLoginRequest, opts ...grpc.CallOption) (*StartLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartLoginResponse)
	err := c.cc.Invoke(ctx, API_StartLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) FinishLogin(ctx context.Context, in *FinishLoginRequest, opts ...grpc.CallOption) (*FinishLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FinishLoginResponse)
	err := c.cc.Invoke(ctx, API_FinishLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIServer) StartLogin(context.Context, *StartLoginRequest) (*StartLoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartLogin not implemented")
}
func (UnimplementedAPIServer) FinishLogin(context.Context, *FinishLoginRequest) (*FinishLoginResponse, error) {
...
func _API_StartLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).StartLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_StartLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).StartLogin(ctx, req.(*StartLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_FinishLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FinishLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).FinishLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_FinishLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).FinishLogin(ctx, req.(*FinishLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _API_StartLogin_Handler,
		},
		{
			MethodName: "FinishLogin",
			Handler:    _API_FinishLogin_Handler,
		},
		{
			MethodName: "Whoami",
